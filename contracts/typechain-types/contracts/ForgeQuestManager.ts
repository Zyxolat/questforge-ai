...
export interface ForgeQuestManagerInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "maxRewardPoolSize",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setMaxRewardPoolSize",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface ForgeQuestManager extends BaseContract {
  ...
  maxRewardPoolSize: TypedContractMethod<[], [bigint], "view">;
  ...
  setMaxRewardPoolSize: TypedContractMethod<
    [newMax: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "maxRewardPoolSize"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "setMaxRewardPoolSize"
